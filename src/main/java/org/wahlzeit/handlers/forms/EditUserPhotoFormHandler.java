...
public class EditUserPhotoFormHandler extends AbstractWebFormHandler
{
    ...
    public EditUserPhotoFormHandler(PhotoManager photoManager, UserManager userManager, SysConfig sysConfig, WebPartHandlerManager webPartHandlerManager, WebPartTemplateService webPartTemplateService)
    {
        super(photoManager, userManager, sysConfig, webPartHandlerManager, webPartTemplateService, PartUtil.EDIT_USER_PHOTO_FORM_FILE, AccessRights.USER);
    }
